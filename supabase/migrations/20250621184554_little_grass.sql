/*
  ...
  2. Tables Updated
    - canvas_assignments: Add user_id for user-specific assignments
    - canvas_courses: Add user_id for user enrollment tracking
    - canvas_announcements: Add user_id for user-specific announcements
    - canvas_schedules: Add user_id for user-specific schedules
    - tasks: Ensure proper user_id relationship
    - task_status: Update to work with user-specific data
    - canvas_sync_status: Ensure user-specific sync tracking

  3. Security
    - Enable RLS on all tables
    - Add comprehensive user-specific policies
